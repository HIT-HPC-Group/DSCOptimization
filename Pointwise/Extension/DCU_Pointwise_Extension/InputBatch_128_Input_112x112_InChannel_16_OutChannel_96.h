...
InputBatch_128_Input_112x112_InChannel_16_OutChannel_96

Grid:
    gridDim.x = (128 * 96 * 112 * 112) / (4 * 8 * 96);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_128_Input_112x112_InChannel_16_OutChannel_96(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
