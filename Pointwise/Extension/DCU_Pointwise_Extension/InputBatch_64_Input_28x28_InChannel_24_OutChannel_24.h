...
InputBatch_64_Input_28x28_InChannel_24_OutChannel_24

Grid:
    gridDim.x = (64 * 24 * 28 * 28) / (4 * 7 * 24);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_64_Input_28x28_InChannel_24_OutChannel_24(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
    ...
    // input
    int blockLoadInputStartIdx = blockIdx.x / 28 * 18816 + (blockIdx.x % 28) / 4 * 112 + (blockIdx.x % 4) / 1 * 7;
    ...
    // Store output
    int blockWriteOutputStartIdx = blockIdx.x / 28 * 18816 + (blockIdx.x % 28) / 4 * 112 + (blockIdx.x % 4) / 1 * 7 + (blockIdx.x % 1) * 18816;
