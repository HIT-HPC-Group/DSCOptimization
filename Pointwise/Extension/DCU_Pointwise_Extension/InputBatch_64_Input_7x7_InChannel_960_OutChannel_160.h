...
InputBatch_64_Input_7x7_InChannel_960_OutChannel_160

Grid:
    gridDim.x = (64 * 160 * 7 * 7) / (4 * 7 * 40);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_64_Input_7x7_InChannel_960_OutChannel_160(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
