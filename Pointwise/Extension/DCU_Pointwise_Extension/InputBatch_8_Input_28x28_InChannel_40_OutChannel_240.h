...
InputBatch_8_Input_28x28_InChannel_40_OutChannel_240

Grid:
    gridDim.x = (8 * 240 * 28 * 28) / (4 * 14 * 80);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_8_Input_28x28_InChannel_40_OutChannel_240(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
