...
InputBatch_128_Input_56x56_InChannel_24_OutChannel_144

Grid:
    gridDim.x = (128 * 144 * 56 * 56) / (4 * 4 * 144);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_128_Input_56x56_InChannel_24_OutChannel_144(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
