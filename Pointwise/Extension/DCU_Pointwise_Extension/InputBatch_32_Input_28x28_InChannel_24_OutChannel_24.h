...
InputBatch_32_Input_28x28_InChannel_24_OutChannel_24

Grid:
    gridDim.x = (32 * 24 * 28 * 28) / (4 * 4 * 24);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_32_Input_28x28_InChannel_24_OutChannel_24(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
