...
__global__ void InputBatch_8_Input_7x7_InChannel_320_OutChannel_1280(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
