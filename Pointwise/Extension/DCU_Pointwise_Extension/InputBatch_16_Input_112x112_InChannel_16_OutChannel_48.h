...
InputBatch_16_Input_112x112_InChannel_16_OutChannel_48

Grid:
    gridDim.x = (16 * 48 * 112 * 112) / (4 * 4 * 48);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_16_Input_112x112_InChannel_16_OutChannel_48(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
