...
InputBatch_64_Input_14x14_InChannel_64_OutChannel_384

Grid:
    gridDim.x = (64 * 384 * 14 * 14) / (4 * 14 * 32);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_64_Input_14x14_InChannel_64_OutChannel_384(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
