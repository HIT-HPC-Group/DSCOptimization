...
__global__ void InputBatch_128_Input_7x7_InChannel_576_OutChannel_160(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
