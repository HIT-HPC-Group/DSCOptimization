...
InputBatch_64_Input_7x7_InChannel_96_OutChannel_96

Grid:
    gridDim.x = (64 * 96 * 7 * 7) / (4 * 7 * 24);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_64_Input_7x7_InChannel_96_OutChannel_96(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
