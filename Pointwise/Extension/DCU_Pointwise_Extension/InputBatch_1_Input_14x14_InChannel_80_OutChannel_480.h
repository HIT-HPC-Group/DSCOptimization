...
__global__ void InputBatch_1_Input_14x14_InChannel_80_OutChannel_480(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
