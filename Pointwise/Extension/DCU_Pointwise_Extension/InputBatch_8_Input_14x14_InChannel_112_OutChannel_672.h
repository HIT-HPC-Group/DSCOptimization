...
InputBatch_8_Input_14x14_InChannel_112_OutChannel_672

Grid:
    gridDim.x = (8 * 672 * 14 * 14) / (4 * 14 * 48);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_8_Input_14x14_InChannel_112_OutChannel_672(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
    ...
    // input
    int blockLoadInputStartIdx = blockIdx.x / 49 * 21952 + (blockIdx.x % 49) / 7 * 28 + (blockIdx.x % 7) / 7 * 14;
    ...
    // Store output
    int blockWriteOutputStartIdx = blockIdx.x / 49 * 131712 + (blockIdx.x % 49) / 7 * 28 + (blockIdx.x % 7) / 7 * 14 + (blockIdx.x % 7) * 18816;
