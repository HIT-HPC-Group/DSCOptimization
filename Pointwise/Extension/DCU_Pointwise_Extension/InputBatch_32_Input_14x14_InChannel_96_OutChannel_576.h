...
InputBatch_32_Input_14x14_InChannel_96_OutChannel_576

Grid:
    gridDim.x = (32 * 576 * 14 * 14) / (4 * 14 * 48);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_32_Input_14x14_InChannel_96_OutChannel_576(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
