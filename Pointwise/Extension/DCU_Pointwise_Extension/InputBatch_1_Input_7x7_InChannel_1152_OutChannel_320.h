...
__global__ void InputBatch_1_Input_7x7_InChannel_1152_OutChannel_320(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
    ...
    // input
    int blockLoadInputStartIdx = blockIdx.x / 70 * 56448 + (blockIdx.x % 70) / 10 * 7 + (blockIdx.x % 10) / 10 * 7;
    ...
    // filter
    int blockLoadFilterStartIdx = (blockIdx.x % 10) * 36864;
    ...
    filterSharedBuffer1[threadIdx.x + 4 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 4 * 256) / 64) * 1152 + ((threadIdx.x + 4 * 256) % 64)];
    filterSharedBuffer1[threadIdx.x + 5 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 5 * 256) / 64) * 1152 + ((threadIdx.x + 5 * 256) % 64)];
    filterSharedBuffer1[threadIdx.x + 6 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 6 * 256) / 64) * 1152 + ((threadIdx.x + 6 * 256) % 64)];
    filterSharedBuffer1[threadIdx.x + 7 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 7 * 256) / 64) * 1152 + ((threadIdx.x + 7 * 256) % 64)];
    __syncthreads();
    ...
    for(int i = 0; i < (inputChannel - 64) / (2 * 64); i++) {
        ...
        filterTemp5 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 4 * 256) / 64) * 1152 + ((threadIdx.x + 4 * 256) % 64)];
        filterTemp6 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 5 * 256) / 64) * 1152 + ((threadIdx.x + 5 * 256) % 64)];
        filterTemp7 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 6 * 256) / 64) * 1152 + ((threadIdx.x + 6 * 256) % 64)];
        filterTemp8 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 7 * 256) / 64) * 1152 + ((threadIdx.x + 7 * 256) % 64)];
    ...
    // Store output
    int blockWriteOutputStartIdx = blockIdx.x / 70 * 15680 + (blockIdx.x % 70) / 10 * 7 + (blockIdx.x % 10) / 10 * 7 + (blockIdx.x % 10) * 1568;
