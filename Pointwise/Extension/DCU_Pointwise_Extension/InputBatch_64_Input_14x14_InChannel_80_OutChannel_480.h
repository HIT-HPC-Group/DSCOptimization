...
InputBatch_64_Input_14x14_InChannel_80_OutChannel_480

Grid:
    gridDim.x = (64 * 480 * 14 * 14) / (4 * 14 * 48);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_64_Input_14x14_InChannel_80_OutChannel_480(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
    ...
    // input
    int blockLoadInputStartIdx = blockIdx.x / 35 * 15680 + (blockIdx.x % 35) / 5 * 28 + (blockIdx.x % 5) / 5 * 14;
    ...
    // Store output
    int blockWriteOutputStartIdx = blockIdx.x / 35 * 94080 + (blockIdx.x % 35) / 5 * 28 + (blockIdx.x % 5) / 5 * 14 + (blockIdx.x % 5) * 18816;
