...
__global__ void InputBatch_8_Input_7x7_InChannel_576_OutChannel_160(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
    ...
    // input
    int blockLoadInputStartIdx = blockIdx.x / 35 * 28224 + (blockIdx.x % 35) / 5 * 7 + (blockIdx.x % 5) / 5 * 7;
    ...
    // filter
    int blockLoadFilterStartIdx = (blockIdx.x % 5) * 18432;
    ...
    filterSharedBuffer1[threadIdx.x + 2 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 2 * 256) / 64) * 576 + ((threadIdx.x + 2 * 256) % 64)];
    filterSharedBuffer1[threadIdx.x + 3 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 3 * 256) / 64) * 576 + ((threadIdx.x + 3 * 256) % 64)];
    filterSharedBuffer1[threadIdx.x + 4 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 4 * 256) / 64) * 576 + ((threadIdx.x + 4 * 256) % 64)];
    filterSharedBuffer1[threadIdx.x + 5 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 5 * 256) / 64) * 576 + ((threadIdx.x + 5 * 256) % 64)];
    filterSharedBuffer1[threadIdx.x + 6 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 6 * 256) / 64) * 576 + ((threadIdx.x + 6 * 256) % 64)];
    filterSharedBuffer1[threadIdx.x + 7 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 7 * 256) / 64) * 576 + ((threadIdx.x + 7 * 256) % 64)];
    __syncthreads();
    ...
    for(int i = 0; i < (inputChannel - 64) / (2 * 64); i++) {
        ...
        filterTemp3 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 2 * 256) / 64) * 576 + ((threadIdx.x + 2 * 256) % 64)];
        filterTemp4 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 3 * 256) / 64) * 576 + ((threadIdx.x + 3 * 256) % 64)];
        filterTemp5 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 4 * 256) / 64) * 576 + ((threadIdx.x + 4 * 256) % 64)];
        filterTemp6 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 5 * 256) / 64) * 576 + ((threadIdx.x + 5 * 256) % 64)];
        filterTemp7 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 6 * 256) / 64) * 576 + ((threadIdx.x + 6 * 256) % 64)];
        filterTemp8 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 7 * 256) / 64) * 576 + ((threadIdx.x + 7 * 256) % 64)];
