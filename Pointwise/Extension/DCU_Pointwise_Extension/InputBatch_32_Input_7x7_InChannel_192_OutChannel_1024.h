...
InputBatch_32_Input_7x7_InChannel_192_OutChannel_1024

Grid:
    gridDim.x = (32 * 1024 * 7 * 7) / (4 * 7 * 32);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_32_Input_7x7_InChannel_192_OutChannel_1024(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
