...
__global__ void InputBatch_1_Input_28x28_InChannel_192_OutChannel_32(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
