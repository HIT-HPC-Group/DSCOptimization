...
__global__ void InputBatch_32_Input_112x112_InChannel_32_OutChannel_16(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
