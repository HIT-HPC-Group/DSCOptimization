...
InputBatch_64_Input_7x7_InChannel_192_OutChannel_1152

Grid:
    gridDim.x = (64 * 1152 * 7 * 7) / (7 * 7 * 48);
Block:
    blockDim.x = 64 * 7;
...
__global__ __launch_bounds__(1024) void InputBatch_64_Input_7x7_InChannel_192_OutChannel_1152(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
