...
InputBatch_8_Input_28x28_InChannel_24_OutChannel_24

Grid:
    gridDim.x = (8 * 24 * 28 * 28) / (4 * 7 * 24);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_8_Input_28x28_InChannel_24_OutChannel_24(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
