...
InputBatch_8_Input_56x56_InChannel_48_OutChannel_24

Grid:
    gridDim.x = (8 * 24 * 56 * 56) / (4 * 7 * 24);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_8_Input_56x56_InChannel_48_OutChannel_24(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
