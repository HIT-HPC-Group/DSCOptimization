...
InputBatch_64_Input_7x7_InChannel_1152_OutChannel_320

Grid:
    gridDim.x = (64 * 320 * 7 * 7) / (4 * 7 * 20);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_64_Input_7x7_InChannel_1152_OutChannel_320(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
