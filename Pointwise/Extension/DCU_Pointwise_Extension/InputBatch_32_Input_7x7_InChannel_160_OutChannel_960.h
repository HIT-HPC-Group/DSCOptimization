...
__global__ __launch_bounds__(1024) void InputBatch_32_Input_7x7_InChannel_160_OutChannel_960(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
