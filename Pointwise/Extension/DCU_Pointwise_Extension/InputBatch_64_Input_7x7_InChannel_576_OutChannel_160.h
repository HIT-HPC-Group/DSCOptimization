...
InputBatch_64_Input_7x7_InChannel_576_OutChannel_160
...
__global__ void InputBatch_64_Input_7x7_InChannel_576_OutChannel_160(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
    ...
    // input
    int blockLoadInputStartIdx = blockIdx.x / 7 * 28224 + (blockIdx.x % 7) / 1 * 7 + (blockIdx.x % 1) / 1 * 7;
    ...
    // filter
    int blockLoadFilterStartIdx = (blockIdx.x % 1) * 92160;
    ...
    filterSharedBuffer1[threadIdx.x + 4 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 4 * 256) / 16) * 576 + ((threadIdx.x + 4 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 5 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 5 * 256) / 16) * 576 + ((threadIdx.x + 5 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 6 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 6 * 256) / 16) * 576 + ((threadIdx.x + 6 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 7 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 7 * 256) / 16) * 576 + ((threadIdx.x + 7 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 8 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 8 * 256) / 16) * 576 + ((threadIdx.x + 8 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 9 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 9 * 256) / 16) * 576 + ((threadIdx.x + 9 * 256) % 16)];
    __syncthreads();
    ...
    for(int i = 0; i < (inputChannel - 16) / (2 * 16); i++) {
        ...
        filterTemp5 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 4 * 256) / 16) * 576 + ((threadIdx.x + 4 * 256) % 16)];
        filterTemp6 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 5 * 256) / 16) * 576 + ((threadIdx.x + 5 * 256) % 16)];
        filterTemp7 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 6 * 256) / 16) * 576 + ((threadIdx.x + 6 * 256) % 16)];
        filterTemp8 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 7 * 256) / 16) * 576 + ((threadIdx.x + 7 * 256) % 16)];
        filterTemp9 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 8 * 256) / 16) * 576 + ((threadIdx.x + 8 * 256) % 16)];
        filterTemp10 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 9 * 256) / 16) * 576 + ((threadIdx.x + 9 * 256) % 16)];
