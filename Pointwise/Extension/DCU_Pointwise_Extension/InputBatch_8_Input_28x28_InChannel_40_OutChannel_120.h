...
InputBatch_8_Input_28x28_InChannel_40_OutChannel_120

Grid:
    gridDim.x = (8 * 120 * 28 * 28) / (4 * 4 * 40);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_8_Input_28x28_InChannel_40_OutChannel_120(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
