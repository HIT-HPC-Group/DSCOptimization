...
InputBatch_64_Input_14x14_InChannel_480_OutChannel_96

Grid:
    gridDim.x = (64 * 96 * 14 * 14) / (4 * 14 * 24);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_64_Input_14x14_InChannel_480_OutChannel_96(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
