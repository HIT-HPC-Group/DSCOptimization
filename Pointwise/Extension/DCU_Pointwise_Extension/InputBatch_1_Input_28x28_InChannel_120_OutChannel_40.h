...
__global__ __launch_bounds__(1024) void InputBatch_1_Input_28x28_InChannel_120_OutChannel_40(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
