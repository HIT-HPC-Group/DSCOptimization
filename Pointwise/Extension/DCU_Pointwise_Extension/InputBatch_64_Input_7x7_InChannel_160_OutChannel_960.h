...
InputBatch_64_Input_7x7_InChannel_160_OutChannel_960

Grid:
    gridDim.x = (64 * 960 * 7 * 7) / (7 * 7 * 48);
Block:
    blockDim.x = 64 * 7;
...
__global__ __launch_bounds__(1024) void InputBatch_64_Input_7x7_InChannel_160_OutChannel_960(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
