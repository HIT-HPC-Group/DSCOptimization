...
InputBatch_16_Input_7x7_InChannel_160_OutChannel_960

Grid:
    gridDim.x = (16 * 960 * 7 * 7) / (4 * 7 * 40);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_16_Input_7x7_InChannel_160_OutChannel_960(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
    ...
    // input
    int blockLoadInputStartIdx = blockIdx.x / 42 * 7840 + (blockIdx.x % 42) / 6 * 7 + (blockIdx.x % 6) / 6 * 7;
    ...
    // filter
    int blockLoadFilterStartIdx = (blockIdx.x % 6) * 25600;
    filterSharedBuffer1[threadIdx.x + 0 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 0 * 256) / 16) * 160 + ((threadIdx.x + 0 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 1 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 1 * 256) / 16) * 160 + ((threadIdx.x + 1 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 2 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 2 * 256) / 16) * 160 + ((threadIdx.x + 2 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 3 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 3 * 256) / 16) * 160 + ((threadIdx.x + 3 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 4 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 4 * 256) / 16) * 160 + ((threadIdx.x + 4 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 5 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 5 * 256) / 16) * 160 + ((threadIdx.x + 5 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 6 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 6 * 256) / 16) * 160 + ((threadIdx.x + 6 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 7 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 7 * 256) / 16) * 160 + ((threadIdx.x + 7 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 8 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 8 * 256) / 16) * 160 + ((threadIdx.x + 8 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 9 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 9 * 256) / 16) * 160 + ((threadIdx.x + 9 * 256) % 16)];
    __syncthreads();
    ...
    for(int i = 0; i < (inputChannel - 16) / (2 * 16); i++) {
        ...
        filterTemp1 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 0 * 256) / 16) * 160 + ((threadIdx.x + 0 * 256) % 16)];
        filterTemp2 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 1 * 256) / 16) * 160 + ((threadIdx.x + 1 * 256) % 16)];
        filterTemp3 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 2 * 256) / 16) * 160 + ((threadIdx.x + 2 * 256) % 16)];
        filterTemp4 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 3 * 256) / 16) * 160 + ((threadIdx.x + 3 * 256) % 16)];
        filterTemp5 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 4 * 256) / 16) * 160 + ((threadIdx.x + 4 * 256) % 16)];
        filterTemp6 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 5 * 256) / 16) * 160 + ((threadIdx.x + 5 * 256) % 16)];
        filterTemp7 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 6 * 256) / 16) * 160 + ((threadIdx.x + 6 * 256) % 16)];
        filterTemp8 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 7 * 256) / 16) * 160 + ((threadIdx.x + 7 * 256) % 16)];
        filterTemp9 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 8 * 256) / 16) * 160 + ((threadIdx.x + 8 * 256) % 16)];
        filterTemp10 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 9 * 256) / 16) * 160 + ((threadIdx.x + 9 * 256) % 16)];
    ...
    // Store output
    int blockWriteOutputStartIdx = blockIdx.x / 42 * 47040 + (blockIdx.x % 42) / 6 * 7 + (blockIdx.x % 6) / 6 * 7 + (blockIdx.x % 6) * 7840;
