...
InputBatch_32_Input_28x28_InChannel_120_OutChannel_40

Grid:
    gridDim.x = (32 * 40 * 28 * 28) / (4 * 7 * 40);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_32_Input_28x28_InChannel_120_OutChannel_40(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
