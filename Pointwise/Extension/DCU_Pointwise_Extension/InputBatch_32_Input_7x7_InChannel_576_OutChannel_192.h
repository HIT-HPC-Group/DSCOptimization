...
InputBatch_32_Input_7x7_InChannel_576_OutChannel_192

Grid:
    gridDim.x = (32 * 192 * 7 * 7) / (4 * 7 * 16);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_32_Input_7x7_InChannel_576_OutChannel_192(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
