...
InputBatch_128_Input_7x7_InChannel_960_OutChannel_320

Grid:
    gridDim.x = (128 * 320 * 7 * 7) / (4 * 7 * 40);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_128_Input_7x7_InChannel_960_OutChannel_320(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
    ...
    // filter
    int blockLoadFilterStartIdx = (blockIdx.x % 2) * 153600;
    filterSharedBuffer1[threadIdx.x + 0 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 0 * 256) / 16) * 960 + ((threadIdx.x + 0 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 1 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 1 * 256) / 16) * 960 + ((threadIdx.x + 1 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 2 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 2 * 256) / 16) * 960 + ((threadIdx.x + 2 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 3 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 3 * 256) / 16) * 960 + ((threadIdx.x + 3 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 4 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 4 * 256) / 16) * 960 + ((threadIdx.x + 4 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 5 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 5 * 256) / 16) * 960 + ((threadIdx.x + 5 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 6 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 6 * 256) / 16) * 960 + ((threadIdx.x + 6 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 7 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 7 * 256) / 16) * 960 + ((threadIdx.x + 7 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 8 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 8 * 256) / 16) * 960 + ((threadIdx.x + 8 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 9 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 9 * 256) / 16) * 960 + ((threadIdx.x + 9 * 256) % 16)];
    __syncthreads();
    ...
    for(int i = 0; i < (inputChannel - 16) / (2 * 16); i++) {
        ...
        filterTemp1 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 0 * 256) / 16) * 960 + ((threadIdx.x + 0 * 256) % 16)];
        filterTemp2 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 1 * 256) / 16) * 960 + ((threadIdx.x + 1 * 256) % 16)];
        filterTemp3 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 2 * 256) / 16) * 960 + ((threadIdx.x + 2 * 256) % 16)];
        filterTemp4 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 3 * 256) / 16) * 960 + ((threadIdx.x + 3 * 256) % 16)];
        filterTemp5 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 4 * 256) / 16) * 960 + ((threadIdx.x + 4 * 256) % 16)];
        filterTemp6 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 5 * 256) / 16) * 960 + ((threadIdx.x + 5 * 256) % 16)];
        filterTemp7 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 6 * 256) / 16) * 960 + ((threadIdx.x + 6 * 256) % 16)];
        filterTemp8 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 7 * 256) / 16) * 960 + ((threadIdx.x + 7 * 256) % 16)];
        filterTemp9 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 8 * 256) / 16) * 960 + ((threadIdx.x + 8 * 256) % 16)];
        filterTemp10 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 9 * 256) / 16) * 960 + ((threadIdx.x + 9 * 256) % 16)];
    ...
    // Store output
    int blockWriteOutputStartIdx = blockIdx.x / 14 * 15680 + (blockIdx.x % 14) / 2 * 7 + (blockIdx.x % 2) / 2 * 7 + (blockIdx.x % 2) * 7840;
