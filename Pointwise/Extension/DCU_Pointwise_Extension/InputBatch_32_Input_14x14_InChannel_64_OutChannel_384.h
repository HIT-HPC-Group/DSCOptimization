...
__global__ void InputBatch_32_Input_14x14_InChannel_64_OutChannel_384(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
