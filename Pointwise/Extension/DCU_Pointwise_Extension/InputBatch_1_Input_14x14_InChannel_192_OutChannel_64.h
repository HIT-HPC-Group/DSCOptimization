...
__global__ void InputBatch_1_Input_14x14_InChannel_192_OutChannel_64(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
