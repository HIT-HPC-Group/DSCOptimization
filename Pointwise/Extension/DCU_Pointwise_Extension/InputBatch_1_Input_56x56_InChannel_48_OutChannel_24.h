...
InputBatch_1_Input_56x56_InChannel_48_OutChannel_24

Grid:
    gridDim.x = (1 * 24 * 56 * 56) / (4 * 4 * 24);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_1_Input_56x56_InChannel_48_OutChannel_24(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
    ...
    // input
    int blockLoadInputStartIdx = blockIdx.x / 196 * 150528 + (blockIdx.x % 196) / 14 * 224 + (blockIdx.x % 14) / 1 * 4;
    ...
    // filter
    int blockLoadFilterStartIdx = (blockIdx.x % 1) * 1152;
    ...
    // Store output
    int blockWriteOutputStartIdx = blockIdx.x / 196 * 75264 + (blockIdx.x % 196) / 14 * 224 + (blockIdx.x % 14) / 1 * 4 + (blockIdx.x % 1) * 75264;
