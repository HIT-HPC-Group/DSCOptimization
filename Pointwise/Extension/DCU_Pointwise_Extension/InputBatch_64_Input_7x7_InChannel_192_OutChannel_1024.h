...
__global__ void InputBatch_64_Input_7x7_InChannel_192_OutChannel_1024(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
