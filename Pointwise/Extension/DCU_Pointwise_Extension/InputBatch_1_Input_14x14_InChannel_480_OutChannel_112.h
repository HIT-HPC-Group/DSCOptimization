...
__global__ __launch_bounds__(1024) void InputBatch_1_Input_14x14_InChannel_480_OutChannel_112(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
