...
InputBatch_64_Input_7x7_InChannel_576_OutChannel_192

Grid:
    gridDim.x = (64 * 192 * 7 * 7) / (4 * 7 * 16);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_64_Input_7x7_InChannel_576_OutChannel_192(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
    ...
    // input
    int blockLoadInputStartIdx = blockIdx.x / 21 * 28224 + (blockIdx.x % 21) / 3 * 7 + (blockIdx.x % 3) / 3 * 7;
    ...
    // filter
    int blockLoadFilterStartIdx = (blockIdx.x % 3) * 36864;
    filterSharedBuffer1[threadIdx.x + 0 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 0 * 256) / 16) * 576 + ((threadIdx.x + 0 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 1 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 1 * 256) / 16) * 576 + ((threadIdx.x + 1 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 2 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 2 * 256) / 16) * 576 + ((threadIdx.x + 2 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 3 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 3 * 256) / 16) * 576 + ((threadIdx.x + 3 * 256) % 16)];
    __syncthreads();
    ...
    for(int i = 0; i < (inputChannel - 16) / (2 * 16); i++) {
        ...
        filterTemp1 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 0 * 256) / 16) * 576 + ((threadIdx.x + 0 * 256) % 16)];
        filterTemp2 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 1 * 256) / 16) * 576 + ((threadIdx.x + 1 * 256) % 16)];
        filterTemp3 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 2 * 256) / 16) * 576 + ((threadIdx.x + 2 * 256) % 16)];
        filterTemp4 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 3 * 256) / 16) * 576 + ((threadIdx.x + 3 * 256) % 16)];
    ...
    // Store output
    int blockWriteOutputStartIdx = blockIdx.x / 21 * 9408 + (blockIdx.x % 21) / 3 * 7 + (blockIdx.x % 3) / 3 * 7 + (blockIdx.x % 3) * 3136;
