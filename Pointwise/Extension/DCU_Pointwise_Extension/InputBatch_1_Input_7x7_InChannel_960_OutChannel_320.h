...
__global__ void InputBatch_1_Input_7x7_InChannel_960_OutChannel_320(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
    ...
    // filter
    int blockLoadFilterStartIdx = (blockIdx.x % 10) * 30720;
