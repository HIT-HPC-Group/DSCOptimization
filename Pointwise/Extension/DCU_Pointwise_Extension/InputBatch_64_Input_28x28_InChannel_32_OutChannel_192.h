...
InputBatch_64_Input_28x28_InChannel_32_OutChannel_192

Grid:
    gridDim.x = (64 * 192 * 28 * 28) / (4 * 4 * 96);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_64_Input_28x28_InChannel_32_OutChannel_192(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
