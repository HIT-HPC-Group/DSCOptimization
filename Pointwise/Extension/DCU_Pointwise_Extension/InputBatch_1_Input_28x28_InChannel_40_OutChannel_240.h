...
__global__ void InputBatch_1_Input_28x28_InChannel_40_OutChannel_240(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
