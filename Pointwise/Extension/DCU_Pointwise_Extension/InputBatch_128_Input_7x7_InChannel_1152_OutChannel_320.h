...
InputBatch_128_Input_7x7_InChannel_1152_OutChannel_320
...
__global__ void InputBatch_128_Input_7x7_InChannel_1152_OutChannel_320(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
    ...
    // filter
    int blockLoadFilterStartIdx = (blockIdx.x % 2) * 184320;
    ...
    filterSharedBuffer1[threadIdx.x + 6 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 6 * 256) / 16) * 1152 + ((threadIdx.x + 6 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 7 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 7 * 256) / 16) * 1152 + ((threadIdx.x + 7 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 8 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 8 * 256) / 16) * 1152 + ((threadIdx.x + 8 * 256) % 16)];
    filterSharedBuffer1[threadIdx.x + 9 * 256] = filter[blockLoadFilterStartIdx + ((threadIdx.x + 9 * 256) / 16) * 1152 + ((threadIdx.x + 9 * 256) % 16)];
    __syncthreads();
    ...
    for(int i = 0; i < (inputChannel - 16) / (2 * 16); i++) {
        ...
        filterTemp7 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 6 * 256) / 16) * 1152 + ((threadIdx.x + 6 * 256) % 16)];
        filterTemp8 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 7 * 256) / 16) * 1152 + ((threadIdx.x + 7 * 256) % 16)];
        filterTemp9 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 8 * 256) / 16) * 1152 + ((threadIdx.x + 8 * 256) % 16)];
        filterTemp10 = filter[blockLoadFilterStartIdx + ((threadIdx.x + 9 * 256) / 16) * 1152 + ((threadIdx.x + 9 * 256) % 16)];
