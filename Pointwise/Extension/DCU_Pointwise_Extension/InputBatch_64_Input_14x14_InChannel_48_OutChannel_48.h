...
InputBatch_64_Input_14x14_InChannel_48_OutChannel_48

Grid:
    gridDim.x = (64 * 48 * 14 * 14) / (4 * 7 * 48);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_64_Input_14x14_InChannel_48_OutChannel_48(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
