...
InputBatch_128_Input_7x7_InChannel_320_OutChannel_1280

Grid:
    gridDim.x = (128 * 1280 * 7 * 7) / (4 * 7 * 40);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_128_Input_7x7_InChannel_320_OutChannel_1280(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
