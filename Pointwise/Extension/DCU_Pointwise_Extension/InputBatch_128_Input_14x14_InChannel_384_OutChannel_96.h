...
__global__ void InputBatch_128_Input_14x14_InChannel_384_OutChannel_96(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
