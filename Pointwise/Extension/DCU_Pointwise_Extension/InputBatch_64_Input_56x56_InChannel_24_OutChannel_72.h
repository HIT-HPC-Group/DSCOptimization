...
InputBatch_64_Input_56x56_InChannel_24_OutChannel_72

Grid:
    gridDim.x = (64 * 72 * 56 * 56) / (4 * 7 * 24);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_64_Input_56x56_InChannel_24_OutChannel_72(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
