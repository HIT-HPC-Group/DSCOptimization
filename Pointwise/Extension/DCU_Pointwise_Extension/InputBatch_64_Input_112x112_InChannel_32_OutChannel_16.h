...
InputBatch_64_Input_112x112_InChannel_32_OutChannel_16

Grid:
    gridDim.x = (64 * 16 * 112 * 112) / (4 * 14 * 16);
Block:
    blockDim.x = 64 * 4;
...
__global__ void InputBatch_64_Input_112x112_InChannel_32_OutChannel_16(const scalar_t* __restrict__ input, const scalar_t* __restrict__ filter, scalar_t* __restrict__ output,
